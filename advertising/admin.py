...
class AdBookingAdmin(ModelAdmin):
    ...
    list_filter = ('status', 'payment_status', 'week_start_date', 'created_at', 'updated_at')
    ...
    def approve_bookings(self, request, queryset):
        ...
        for booking in queryset:
            ...
            booking.save()
        self.message_user(request, f"Approved {count} bookings and dispatched emails.")
    ...
    def reject_bookings(self, request, queryset):
        ...
        for booking in queryset:
            ...
            booking.save()
        self.message_user(request, f"Rejected {count} bookings and dispatched feedback.")
...
class AdExtensionAdmin(ModelAdmin):
    ...
    list_filter = ('status', 'payment_status', 'extended_week_start', 'created_at')
