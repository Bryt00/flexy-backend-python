...
class PushNotificationProvider(ABC):
    @abstractmethod
    def send_push(self, user_id: str, title: Union[str, Dict[str, str]], message: Union[str, Dict[str, str]], data: dict = None, android_channel_id: str = None, android_sound: str = None, ios_sound: str = None) -> bool:
        """
