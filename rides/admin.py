...
class RideAdmin(ModelAdmin):
    list_display = ('short_id', 'rider', 'driver', 'status_badge', 'type', 'fare_display', 'created_at')
    ...
    readonly_fields = ('id', 'created_at', 'updated_at', 'dispatch_metadata')
    list_per_page = 30
    ordering = ('-created_at',)
    ...
    fieldsets = (
        ...
        ('Financials', {
            'fields': ('fare', 'payment_method', 'surge_multiplier'),
        }),
        ('Scheduling', {
