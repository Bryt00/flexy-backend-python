...
urlpatterns = [
    ...
    path('press/', views.PressListView.as_view(), name='press'),
    path('press/<slug:slug>/', views.PressDetailView.as_view(), name='press_detail'),
    path('corporate/', views.CorporateView.as_view(), name='corporate'),
    path('legal/', views.LegalHubView.as_view(), name='legal_hub'),
    ...
    path('legal/doc/<slug:slug>/', views.LegalDocumentView.as_view(), name='legal_detail'),
